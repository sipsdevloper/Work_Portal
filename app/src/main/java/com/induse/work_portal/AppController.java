...
public class AppController extends Application {
    ...
    public static final String TAG = com.induse.work_portal.AppController.class.getSimpleName();
   // NetworkConnectionCheck connectionCheck;

    private RequestQueue mRequestQueue;


    private static com.induse.work_portal.AppController mInstance;
...
//        Realm.setDefaultConfiguration(realmConfiguration);
    ...
    public static synchronized com.induse.work_portal.AppController getInstance() {
